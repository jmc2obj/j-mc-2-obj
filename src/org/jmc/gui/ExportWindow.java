...
public class ExportWindow extends JFrame implements ProgressCallback{
	...
	public ExportWindow() {
		...
		pMapExportOffset.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
		
		JPanel holderOffsetBtns = new JPanel();
		pMapExportOffset.add(holderOffsetBtns);
		...
		pMapExportOffset.add(holderOffsetFields);
		...
		pTextureOptions.add(holderPreScale);
			holderPreScale.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
		...
		holderMapScale.setAlignmentX(Component.LEFT_ALIGNMENT);
		pExportOptions.add(holderMapScale);
		...
		holderUV.setLayout(new FlowLayout(FlowLayout.LEFT, 5, 5));
		...
		holderExportBtns.setAlignmentX(Component.LEFT_ALIGNMENT);
		pExportOptions.add(holderExportBtns);
		holderExportBtns.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
