...
public class Composter extends BlockModel
{
	...
	public void addModel(ChunkProcessor obj, ThreadChunkDeligate chunks, int x, int y, int z, BlockData data, int biome)
	{
		...
		String[] mtls_mainBox = new String [] { materials.get(data,biome)[4], materials.get(data,biome)[3], materials.get(data,biome)[3], materials.get(data,biome)[3], materials.get(data,biome)[3], materials.get(data,biome)[0] };			
		...
		if (level > 0 && level < 8)
		{
			...
			obj.addFace(vertices, uvCompost, move, materials.get(data,biome)[1]);	
		}
		...
		else if (level == 8)
		{
			...
			obj.addFace(vertices, uvCompost, move, materials.get(data,biome)[2]);			
		}	
	}
}
