...
public class Scaffolding extends BlockModel
{
	...
	public void addModel(ChunkProcessor obj, ThreadChunkDeligate chunks, int x, int y, int z, BlockData data, int biome)
	{
		...
		String[] mtls_Top = new String [] { getMtlSides(data, biome)[0], getMtlSides(data, biome)[1], getMtlSides(data, biome)[1], getMtlSides(data, biome)[1], getMtlSides(data, biome)[1], getMtlSides(data, biome)[5] };	
		String[] mtls_Poles = new String [] { getMtlSides(data, biome)[1], getMtlSides(data, biome)[1], getMtlSides(data, biome)[1], getMtlSides(data, biome)[1], getMtlSides(data, biome)[1], getMtlSides(data, biome)[5] };	
		...
		if (data.get("bottom").equals("false"))
		{
